 ...
 *
 * Extended by Roland Glantz <roland.glantz@kit.edu>
 *
...
#ifndef KARMA_CONFIG_DI1ES4T0
#define KARMA_CONFIG_DI1ES4T0
...
struct PartitionConfig
{
  ...
  // variables controlling repartitioning

  std::string filename_old_graph;

  std::string filename_ancestors;

  double new_imbalance;

  int new_k;

  bool diffusive_refinement;

  bool trunccons_limited;

  bool trunccons_limited_useAllNeighbors;

  bool scale_balancing;

  bool flow_based_balancing;

  bool greedy_balancing;

  int trunccons_numDiffIters;

  int trunccons_numConsols;

  int trunccons_limited_sizeOfNeighborhood;

  int scale_balancing_iters;

  //=======================================
  //================MAPPING================
  //=======================================

  // variables controlling mapping

  std::string mapping_algo;

  int numberHierarchies;

  std::string multikahip_preconfiguration;

  std::string proc_graph_type;

  std::string proc_graph_extensions;

  std::string proc_graph_bandwidths;
...
#endif /* end of include guard: KARMA_CONFIG_DI1ES4T0 */
