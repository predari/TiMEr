/******************************************************************************
 * graph_partitioner_m.cpp 
 *
 * copied and slightely modified from graph_partitioner.cpp:
 *
...
graph_partitioner_m::graph_partitioner_m() {
...
void graph_partitioner_m::perform_recursive_partitioning(PartitionConfig & config, graph_access & G) {
        m_global_k = config.k;
...
void graph_partitioner_m::perform_recursive_partitioning_internal(PartitionConfig & config, 
                                                                graph_access & G, 
                                                                PartitionID lb, 
                                                                PartitionID ub) {
...
void graph_partitioner_m::single_run( PartitionConfig & config, graph_access & G) {
...
void graph_partitioner_m::perform_partitioning( PartitionConfig & config, graph_access & G) {
